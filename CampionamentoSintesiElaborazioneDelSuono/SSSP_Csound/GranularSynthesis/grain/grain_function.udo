...
opcode features_sound_granulation, 0, Siiiiiiiiiiiiii
    Sinstr, ifile, if_min, if_max, ia_min, ia_max, ip_min, ip_max, ipan_min, ipan_max, idur_min, idur_max, ihop_min, ihop_max, imode_value xin
    ilen = ftlen(ifile)
