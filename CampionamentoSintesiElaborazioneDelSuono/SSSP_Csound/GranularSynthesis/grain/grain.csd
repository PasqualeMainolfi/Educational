...
if_min, if_max = 0.5, 1.2
ia_min, ia_max = .5, .707
ip_min, ip_max = 0, 0
ipan_min, ipan_max = .5, .5
idur_min, idur_max = .01, .03
ir_min, ir_max = .001, .01
imode = 1

isorgente = open_file("testGrain_3.wav")
ilive = live_input(44100, 1)

features_sound_granulation("voce1", isorgente, if_min, if_max, ia_min, ia_max, ip_min, ip_max, ipan_min, ipan_max, idur_min, idur_max, ir_min, ir_max, imode)
  endin

  instr voce1
al, ar sound_granulation p4, p5, p6, p7, p8, p9, p10, p11, p12
outs(al, ar)
  endin
